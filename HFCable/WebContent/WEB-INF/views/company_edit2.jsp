	...
	<div class="bodywrapper">
		...
		<div class="centercontent">
			...
			<div class="pageheader">
				...
				<!--contenttitle-->
				<form:form class="stdform" modelAttribute="company" action="${pageContext.request.contextPath}/company/save/logo" method="post" enctype="multipart/form-data">
					<p>
						<label>公司logo：</label> <span class="field"><input type="file" name="file" class="smallinput" /></span>
					</p>
					<br clear="all" />
					<br />
					<p class="stdformbutton">
						<input type="submit" class="submit radius2" value="上传" />
					</p>
				</form:form>
			</div>
			<!--contentwrapper-->
