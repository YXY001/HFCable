...
<script type="text/javascript">
	function checknull() {
		...
		if (productIntroduction.val() == '' || productIntroduction.val() == 0) {
		...
		<div class="centercontent">
			...
			<div class="pageheader">
				...
				<form:form class="stdform" modelAttribute="company" action="${pageContext.request.contextPath}/company/save" method="post">
					...
					<p>
						<label>公司产品介绍</label> <span class="field"><form:textarea path="productIntroduction" class="smallinput" /></span><span class="field" id="productIntroduction1" style="display: none; color: red; font-weight: bold">请填写公司产品介绍</span>
					</p>
					<br clear="all" />
					<br />
