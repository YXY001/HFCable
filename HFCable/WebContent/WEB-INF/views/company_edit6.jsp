		...
		<div class="centercontent">
			...
			<div class="pageheader">
				...
				<form:form class="stdform" modelAttribute="company" action="${pageContext.request.contextPath}/company/save" method="post">
					...
					<p>
						<label>公司电话</label> <span class="field"><form:input path="telephone" class="smallinput" /></span> <span class="field" id="telephone1" style="display: none; color: red; font-weight: bold">请填写公司电话</span>
					</p>
					<br clear="all" />
					<br />
