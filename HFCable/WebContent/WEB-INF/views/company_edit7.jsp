		...
		<div class="centercontent">
			...
			<div class="pageheader">
				...
				<form:form class="stdform" modelAttribute="company" action="${pageContext.request.contextPath}/company/save" method="post">
					...
					<p>
						<label>公司邮编</label> <span class="field"><form:input path="zipCode" class="smallinput" /></span><span class="field" id="zipCode1" style="display: none; color: red; font-weight: bold">请填写公司邮编</span>
					</p>
					<br clear="all" />
					<br />
