...
<body class="withvernav">
	...
	<div class="bodywrapper">
		...
		<div class="vernav iconmenu">
			<ul>
				<li class="current"><a href="${pageContext.request.contextPath }/product/toProduct" class="inbox">新增产品</a></li>
		...
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<!--contenttitle-->
				<form class="stdform stdform2" method="post" action="${pageContext.request.contextPath }/product/save" enctype="multipart/form-data">
					<p>
						<label>产品名称</label> <span class="field"><input type="text" id="prodectName" name="prodectName" class="smallinput"> <span id="prodectNameNull" style="display: none; color: red; font-weight: bold">请填写产品名称</span></span>
					</p>
					<p>
						<label>所属种类</label> <span class="field"> <select id="selection2" height="30" name="id">
					...
					<!--  <p>
                            <label>产品图片</label>
                            <span class="field"><input type="file" id="productImg" name="productImg"  class="smallinput" />
                            <input type="file" id="productImg" name="productImg"  class="smallinput" />
                            <span id="productImgNull" style="display: none; color: red; font-weight: bold">请上传图片</span></span>
                        </p> -->
					<p>
						<label>产品价格</label> <span class="field"><input type="text" id="price" name="price" class="smallinput" /> <span id="priceNull" style="display: none; color: red; font-weight: bold">请输入正确格式（整数或小数）</span> <span id="priceNull1" style="display: none; color: red; font-weight: bold">请填写价格</span> </span>
					</p>
					<p>
						<label>产品规格</label> <span class="field"><input type="text" id="specifications" name="specifications" class="smallinput" /> <span id="specificationsNull" style="display: none; color: red; font-weight: bold">请填写产品规格</span> </span>
					</p>
					<p>
						<label>产品型号</label> <span class="field"><input type="text" id="model" name="model" class="smallinput" /> <span id="modelNull" style="display: none; color: red; font-weight: bold">请填写产品型号</span></span>
					</p>
					<p>
						<label>线芯种类</label> <span class="field"><input type="text" id="lineCoreType" name="lineCoreType" class="smallinput" /> <span id="lineCoreTypeNull" style="display: none; color: red; font-weight: bold">请填写线芯种类</span></span>
					</p>
					<p>
						<label>产品说明</label> <span class="field"><input type="text" id="detail" name="detail" class="smallinput" /> <span id="detailNull" style="display: none; color: red; font-weight: bold">请填写详细说明</span></span>
					</p>
					<p class="stdformbutton">
						<button class="submit radius2" onclick="return checknull();">完成添加</button>
