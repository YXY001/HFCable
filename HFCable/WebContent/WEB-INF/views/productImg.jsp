...
<script type="text/javascript" language="javascript">
	...
	function checknull() {
		...
		if (productImg.val() == '' || productImg.val == 0) {
	...
	<div class="bodywrapper">
		...
		<div class="vernav iconmenu">
			<ul>
				...
				<li class="current"><a href="${pageContext.request.contextPath }/productImage/get" class="inbox">添加产品图片</a></li>
			</ul>
		...
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<!--contenttitle-->
				<form class="stdform stdform2" method="post" action="${pageContext.request.contextPath }/productImage/save?id=${productId}" enctype="multipart/form-data">

					<p>
						<label>产品图片</label> <span class="field"><input type="file" id="productImg" name="productImg" class="smallinput" /> <span id="productImgNull" style="display: none; color: red; font-weight: bold">请上传图片</span></span>
					</p>
					<p>
						<label>产品图片</label> <span class="field"><input type="file" id="productImg" name="productImg" class="smallinput" /> <span id="productImgNull" style="display: none; color: red; font-weight: bold">请上传图片</span></span>
					</p>
