	...
	<div class="bodywrapper">
		...
		<div class="vernav iconmenu">
			<ul>
				...
				<li class="current"><a href="${pageContext.request.contextPath }/product/get" class="drafts">管理产品</a></li>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
					...
					<thead>
						<tr>
							...
							<th class="head1">所属种类</th>
							<th class="head0">产品价格</th>
							<th class="head0">产品规格</th>
							<th class="head0">产品型号</th>
							<th class="head0">线芯种类</th>
							<th class="head0">产品说明</th>
							<th class="head1">操作</th>
						</tr>
					</thead>

					<tbody>
						<c:forEach varStatus="states" items="${productList}" var="product">
							<tr class="xt-bg">
								...
								<td>${product.model }</td>
								<td>${product.lineCoreType }</td>
								<td>${product.detail }</td>
								<td><a href="${pageContext.request.contextPath }/product/delete?id=${product.id}" class="btn btn_orange btn_flag" onclick="return confirm('确定要删除吗？');"><span>删除</span></a> <a href="${pageContext.request.contextPath }/product/toUpdate?id=${product.id}" class="btn btn_orange btn_link"><span>修改</span></a> <a href="${pageContext.request.contextPath }/productImage/toSave?id=${product.id}" class="btn btn_orange btn_link"><span>添加产品图片</span></a></td>
							</tr>
						</c:forEach>
