...
<body class="withvernav">
	...
	<div class="bodywrapper">
		...
		<div class="vernav iconmenu">
			<ul>
				<li class="current"><a href="${pageContext.request.contextPath }/type/toType" class="inbox">新增种类</a></li>
				<li><a href="${pageContext.request.contextPath }/type/get" class="drafts">管理种类</a></li>
		...
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<form class="stdform stdform2" method="post" action="${pageContext.request.contextPath }/type/save">

					<p>
						<label>种类名称</label> <span class="field"> <input type="text" id="username" name="typeNmae" class="smallinput"><span id="namenull" style="display: none; color: red; font-weight: bold">请填写种类名称</span></span>
					</p>
					<p class="stdformbutton">
						<button class="submit radius2" type="submit" onclick="return checknull();">完成创建</button>
